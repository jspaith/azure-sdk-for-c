    ...
    int32_t* out_version)
{
  ...
  if (response_type == AZ_IOT_HUB_CLIENT_PROPERTY_RESPONSE_TYPE_GET)
  {
    ...
    az_iot_hub_client_property_response_type response_type)
{
  ...
  while (true)
  {
    ...
    if ((response_type == AZ_IOT_HUB_CLIENT_PROPERTY_RESPONSE_TYPE_DESIRED_PROPERTIES
         && jr->_internal.bit_stack._internal.current_depth == 1)
        || (response_type == AZ_IOT_HUB_CLIENT_PROPERTY_RESPONSE_TYPE_GET
