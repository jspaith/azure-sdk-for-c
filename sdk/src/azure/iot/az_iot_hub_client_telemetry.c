...
{
    return az_iot_client_telemetry_with_component_get_publish_topic(
        client,
        AZ_SPAN_EMPTY,
        (az_iot_message_properties*)properties, // TODO: To make compile since we changed const in API signature.  To discuss.
        mqtt_topic,
        mqtt_topic_size,
    ...
    size_t* out_mqtt_topic_length)
{
  ...
  // TODO: Can below be merged into a helper with common code from the non-component logic?
